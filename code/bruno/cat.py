...
cb_clf = CatBoostClassifier(params=cb_params)
...
# Fit final model
cb_clf.fit(X=train_df, y=y_train, cat_features=cat_feats_idx)

""" Predict on test set and create submission """
y_pred = cb_clf.predict(valid_df)

#submission['CustomerInterest'] = y_pred
#
#submission.to_csv(path2+"cat_001.csv", index=False)
#y_pred.to_csv(path2+'cat_001.csv', index=False)
